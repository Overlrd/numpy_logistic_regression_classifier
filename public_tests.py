...
def sigmoid_test(target):
    ...
    print('\033[92msigmoid tests passed!\033[0m')
...
def propagate_test(target):
    ...
    print('\033[92mPropagate tests passed!\033[0m')
...
def optimize_test(target):
    ...
    print('\033[92mOptimize tests passed!\033[0m')
...
def predict_test(target):
    ...
    print('\033[92mPredict tests passed!\033[0m')
...
def model_test(target):
    ...
    print('\033[92mModel tests passed!')
